        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-6 border border-purple-500/30">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              ...
              probability, statistics, and actuarial science. It is one of the continuous distributions included in Exam P.
            </p>
          </div>
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                <p className="text-purple-400 font-semibold mb-2">Core Exam P Topic</p>
                <p className="text-slate-300 text-sm">
                  The normal distribution is part of the syllabus. Become
