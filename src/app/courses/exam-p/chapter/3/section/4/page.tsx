...
export default function Section34Page() {
  ...
  const learnSections = [
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-6 border border-purple-500/30">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              ...
              your toolkit for continuous probability. Beta belongs to the core Exam P path. Weibull and Pareto are optional
              enrichment for broader probability and risk study.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <p className="text-yellow-200">
              ...
              commonly tested Beta property in probability study. If you remember nothing else, remember this.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm mt-3">
              This is a useful order-statistics fact. It connects order statistics directly to the Beta family.
            </p>
          </div>
        </div>
      ),
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                ...
                <p className="text-slate-300 text-sm">
                  Controls the failure rate behavior. This is the critical parameter in probability study.
                  <br/><br/>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-xl p-6 border border-orange-500/30">
            ...
            <p className="text-slate-300 mb-4">
              ...
              the parameterization used in this optional enrichment lesson.
            </p>
            <div className="space-y-3">
              <div className="bg-slate-900/80 rounded-lg p-4 text-center">
    ...
    // Section 6: Pareto Properties & Insurance
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <p className="text-yellow-200">
              <strong>Enrichment focus:</strong> The most commonly tested Pareto properties are (1) when
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-xl p-6 border border-green-500/30">
            ...
            <p className="text-slate-300">
              Understanding relationships between distributions helps in probability study when you need to
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <p className="text-yellow-200">
              ...
              check if the result follows one of these known distributions. Many probability problems are
    ...
    // Section 10: Model Reference & Enrichment
    {
      title: 'Model Reference & Enrichment',
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-red-500/20 to-yellow-500/20 rounded-xl p-6 border border-red-500/30">
            ...
            <p className="text-slate-300">
              Use beta for core exam preparation. Explore the other models as optional enrichment.
            </p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <header className="border-b border-slate-700 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-4">
          <Link href="/courses/exam-p/chapter/3" className="p-2 hover:bg-slate-700 rounded-lg transition-colors">
          ...
          <div className="space-y-8">
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
              ...
              <p className="text-slate-400">
                ...
                these practice problems, including optional enrichment covering CDF calculations, moment conditions,
